...
router.patch('/user-details/:id',requireAuth, userController.userupdate)
router.get('/',requireAuth, userController.get_details);
...
router.get('/:email', userController.admin);
